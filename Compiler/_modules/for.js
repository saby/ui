   ...
   var forM = {
      module: function forModule(tag, data) {
         ...
         function resolveStatement2() {
            ...
            var processed = this._process(
               fromAttr ? [statelessTag] : statelessTag.children,
               data
            );
         ...
         function resolveStatement() {
            ...
            var variableNode = new Statement.VariableNode(
               tag.forSource.main,
               false,
               undefined
            );
