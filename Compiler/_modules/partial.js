define('Compiler/_modules/partial', [
   ...
   function prepareDataForCodeGeneration(tag, data, decor) {
      ...
      var vdomContext = (
          'isVdom ? ' + this.esGenerator.genStringInterpolation(
   ...
   function processNode(tag, data, decor) {
      ...
      var inlineTemplateFunction =
         JsTemplates.generatePartialTemplate(inlineTemplateBody, this.esGenerator);
      return (
         Generator.genCreateControlNew(
            'inline',
            templateValue,
         ...
         return function resolveStatement(decor) {
            ...
            var beforeCallFn = (
               ...
               this.esGenerator.genArrowFunction(
                  'attrsForTemplate = ' + createAttribs + ';' +
            ...
            var afterCallFn = (
               '(' +
               this.esGenerator.genArrowFunction(
                  'attrsForTemplate = null;' +
                  'scopeForTemplate = null;'
               ) +
               ')(),'
            );
            ...
            return (
               beforeCallFn +
               tpl + '.call(this, scopeForTemplate, attrsForTemplate, context, isVdom),' +
               afterCallFn
            );
         };
      }
