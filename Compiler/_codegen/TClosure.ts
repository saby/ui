...
export function genRegisterDeserializableIdentifiers(
    ...
    // TODO: только в 23.4100 для совместимости
    return `${T_HELPERS_NAME}.rdi && ${T_HELPERS_NAME}.rdi /* registerDeserializableIdentifiers */(${T_HELPERS_NAME}, ${depsLocal}, ${viewController});`;
}
