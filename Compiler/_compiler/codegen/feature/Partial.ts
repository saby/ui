...
export function createConfigNew(
    ...
    if (compositeAttributes) {
        partialConfig[generator.genDynamicObjectProperty('compositeAttributes')] =
            compositeAttributes;
    }
    ...
    if (isContainerNode) {
        partialConfig[isContainerNodeProperty] =
            generator.genOptionalChaining('attr?.isControlTemplate');
    }
