define('Compiler/_compiler/codegen/function', [
   'Compiler/_compiler/utils/Helpers',
   'Compiler/_compiler/expressions/Process',
   'Compiler/_compiler/expressions/Event',
   'Compiler/_compiler/modules/utils/common',
   'Compiler/_compiler/modules/if',
   'Compiler/_compiler/modules/for',
   'Compiler/_compiler/modules/else',
   'Compiler/_compiler/modules/partial',
   'Compiler/_compiler/modules/template',
   ...
   'Compiler/_compiler/codegen/ECMAScript'
   ...
   var processing = {
      ...
      getFuncName: function getFuncName(propertyName, fileName, wsTemplateName) {
         ...
         var functionName =
            fnByTmpl || fnByFile || propertyName || builderConfig.default.privateFunctionName;
      ...
      setFunctionName: function (func, wsTemplateName, fileName, propertyName) {
         ...
         if (!isFunctionNameConfigurable(func)) {
            return this.getFuncName(builderConfig.default.privateFunctionName);
         }
      ...
      _generateTag: function generateTag(tag, data, decor, parentNS) {
         ...
         Object.keys(processed.attributes).forEach(function (attributeName) {
            processed.attributes[attributeName] = processed.attributes[attributeName].replace(
               /^' \+ (.*?) \+ '$/g,
               function (str, p) {
                  return '¥' + p.replace(/\\/g, '\\\\') + '¥';
               }
