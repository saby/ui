    ...
    private processOption(
        ...
        try {
            ...
            if (attributeValue === null) {
                ...
                // TODO: эта проверка положит сборку. Необходимо сначала исправить ошибки в шаблонах, затем ее включить
                // let allowedContent = TextContentFlags.FULL_TEXT;
                // if (attributeNode.name === 'scope') {
                //     // Требование: scope опция может содержать только Mustache выражение
