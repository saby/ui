...
import type { IPath } from './Resolvers';
 ...
 * @private
 */
export interface IAstVisitor<TContext, TReturn> {
    /**
     * Visit attribute node.
     * @param node {AttributeNode} Concrete attribute node.
     * @param context {*?} Concrete visitor context.
     */
    visitAttribute(node: AttributeNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitOption(node: OptionNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitContentOption(node: ContentOptionNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitBind(node: BindNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitEvent(node: EventNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitElement(node: ElementNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitDoctype(node: DoctypeNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitCData(node: CDataNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitInstruction(node: InstructionNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitComment(node: CommentNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitComponent(node: ComponentNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitInlineTemplate(node: InlineTemplateNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitStaticPartial(node: StaticPartialNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitDynamicPartial(node: DynamicPartialNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitTemplate(node: TemplateNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitIf(node: IfNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitElse(node: ElseNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitFor(node: ForNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitForeach(node: ForeachNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitArray(node: ArrayNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitBoolean(node: BooleanNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitFunction(node: FunctionNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitNumber(node: NumberNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitObject(node: ObjectNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitString(node: StringNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitValue(node: ValueNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitText(node: TextNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitTextData(node: TextDataNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitExpression(node: ExpressionNode, context?: TContext): TReturn;
     ...
     * @param context {*?} Concrete visitor context.
     */
    visitTranslation(node: TranslationNode, context?: TContext): TReturn;
}

/**
 * Object-like type of abstract syntax nodes.
 */
export declare type IProperties =
    IAttributes
    | IEvents
    | IOptions
    | IContents
 ...
 */
export function visitAll<TContext, TReturn>(
    visitor: IAstVisitor<TContext, TReturn>,
    nodes: Ast[],
    context?: TContext
): TReturn[] {
    return nodes.map(node => node.accept(visitor, context)).filter(isNotUndefined);
}

/**
 * Context interface for node iteration with providing extra information about siblings and parent.
 * @private
 */
 ...
 * @param context {IContext} Current context for visitor.
 */
export function navigateAll<TContext extends INavigationContext, TReturn>(
    visitor: IAstVisitor<TContext, TReturn>,
    nodes: Ast[],
    context: TContext
): TReturn[] {
    const iterator = (node: Ast, index: number) => {
        return node.accept(visitor, {
            ...context,
            key: `${context.key}${node.wsKey}_`,
            prev: index - 1 > -1
                ? nodes[index - 1]
                : undefined,
    ...
    return nodes.map(iterator).filter(isNotUndefined);
}
 ...
 * @param context {IContext} Current context for visitor.
 */
export function navigateAllProperties<TContext extends INavigationContext, TReturn>(
    visitor: IAstVisitor<TContext, TReturn>,
    ...
    Object.keys(properties).forEach((name, index, array) => {
        const value = properties[name].accept(visitor, {
            ...context,
            key: `${context.key}${properties[name].wsKey}_`,
            prev: index - 1 > -1
                ? properties[array[index - 1]]
                : undefined,
            next: index + 1 < array.length
                ? properties[array[index + 1]]
                : undefined
        });
 ...
 * @param context {IContext} Current context for visitor.
 */
export function visitAllProperties<TContext, TReturn>(
    visitor: IAstVisitor<TContext, TReturn>,
    properties: IProperties,
    context?: TContext
): Record<string, TReturn> {
    ...
    for (const name in properties) {
        if (properties.hasOwnProperty(name)) {
            const value = properties[name].accept(visitor, context);
...
export abstract class Ast {
    ...
    /**
     * Flag for root element node.
     */
    wsIsRootElementNode: boolean;

    /**
     * Flag for root component node.
     */
    wsIsRootComponentNode: boolean;
    ...
    /**
     * Container with mustache expressions.
     */
    ...
    protected constructor(flags: Flags = Flags.VALIDATED) {
        this.wsKey = 0;
        this.wsFlags = flags;
        this.wsIsRootElementNode = false;
        this.wsIsRootComponentNode = false;
     ...
     * @param context {*?} Concrete visitor context.
     */
    abstract accept<TContext, TReturn>(visitor: IAstVisitor<TContext, TReturn>, context?: TContext): TReturn;
}
...
export abstract class BaseWasabyElement extends BaseHtmlElement {
    ...
    hasOption(name: string): boolean {
        return this.wsOptions.hasOwnProperty(name) || this.wsContents.hasOwnProperty(name);
    }
}
...
export class AttributeNode extends Ast {
     ...
     * @param context {*?} Concrete visitor context.
     */
    accept<TContext, TReturn>(visitor: IAstVisitor<TContext, TReturn>, context?: TContext): TReturn {
...
export class FunctionNode extends Ast {
     ...
     * @param wsFunction {TText[]} Path to function.
     * @param options {IOptions} Collection of function options.
     */
    constructor(wsFunction: TText[], options: IOptions = {}) {
        super();
