...
export interface IChainGenerator<MustacheType, BodyType, ReturnType> {
    elif(test: MustacheType, body: BodyType): ReturnType;

    else(body: BodyType): ReturnType;
 ...
 * @private
 */
export interface IDescription<BodyType> {
...
export interface IFormatter {
     ...
     */
    formatLine(line: TPrimitive, offset?: number): string;
...
export interface IECMAScriptGenerator {
    ...
    /**
     * Generate string template interpolation.
     * @param {string} templateLiteral Template string.
     */
    toStringInterpolation(templateLiteral: string): string;

    /**
     * Generate optional chaining expression.
     * @param {string} memberExpression Member expression in its optional chaining form.
     */
    toOptionalChaining(memberExpression: string): string;

    /**
     * Generate nullish coalescing operator.
     * @param {string} expression Some expression.
