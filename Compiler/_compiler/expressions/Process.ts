...
import { genEscape } from '../codegen/Generator';
import { genSanitize } from '../codegen/TClosure';
import { ExpressionVisitor } from '../codegen/Expression';
...
export function processExpressions(
    ...
    if (exprAsLocalization.type === 'var' && exprAsLocalization.localized) {
        ...
        res = exprAsLocalization.name.replace(/\\/g, '\\\\').replace(/"/g, '\\"');
