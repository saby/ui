...
import { BindExpressionVisitor } from '../codegen/Expression';
...
import { Generator } from '../codegen/ECMAScript';
...
export function processBindAttribute(
    ...
    fn = FSC.wrapAroundExec(generator.genArrowExpression(fn, ['data', 'value']));
