define('Compiler/_compiler/modules/data/object', [
   ...
   function writeObjectEntity(typeFunction, injected, types, scopeData, propName, falsy) {
      try {
         return typeFunction.call(this, injected, types, scopeData, propName, falsy);
      } catch (error) {
         throw new Error(
   ...
   return function objectTag(injected, types, scopeData, propertyName, restricted, root) {
      ...
      if (injected.wsInternalTree && this.internalFunctions) {
         ...
         injected.internal = Internal.generate(injected.wsInternalTree, this.internalFunctions);
      }
      ...
      if (templateObject.html.length > 0) {
         ...
         if (tObject.type === 'string') {
            ...
            result = FSC.wrapAroundObject(
               '(' +
                  this.getFunction(html, templateObject.data, this.handlers, undefined, false)
                     .toString()
                     .replace(/\n/g, ' ') +
