            ...
            if (attributes.hasOwnProperty(attributeName)) {
                ...
                if (isBind(attributeName)) {
                    ...
                    if (bindNode) {
                        ...
                        collection.events[`bind:${bindNode.__$ws_property}`] =
                            bindNode;
                    }
                    continue;
                }
                if (isEvent(attributeName)) {
                    ...
                    if (eventNode) {
                        ...
                        collection.events[`on:${eventNode.__$ws_event}`] =
                            eventNode;
                    }
                    continue;
                }
                if (isAttribute(attributeName) || options.hasAttributesOnly) {
                    ...
                    if (attributeNode) {
                        ...
                        attributeNode.__$ws_hasAttributePrefix =
                            hasWasabyPrefix(attributeName);
                        if (
                            collection.attributes.hasOwnProperty(
                                `attr:${attributeNode.__$ws_name}`
                            )
                        ) {
