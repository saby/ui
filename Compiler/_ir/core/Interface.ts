...
/**
 * Способ обработки исключительных ситуаций при построении шаблона.
 */
export type TemplateExceptionsMode = 'warn' | 'throw';
...
export interface IArguments {
    ...
    /**
     * 8й аргумент вызова шаблонной функции.
     * Способ обработки исключительных ситуаций при построении шаблона.
     */
    templateExceptionMode: TemplateExceptionsMode;
}
...
export interface IContext {
     ...
     */
    readonly d: IContext['data'];

    /**
     * (viewController) Инстанс текущего контроллера.
     */
    readonly v: IContext['viewController'];
...
export interface TemplateFunction extends Function {
    ...
    /**
     * Информация о шаблонной функции.
     */
    templateInfo: string;
