...
const Iterators = [
    ...
    },
    {
        ...
        iterator: function objectIterator(object: Record<string, unknown>, callback: Callback): void {
 ...
 */
export default function getIterator(entity: unknown): Iterator | undefined {
    for (const it of Iterators) {
        if (it.is(entity)) {
            return it.iterator as Iterator;
        }
    }
