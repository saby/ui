...
export interface IDescription {
    ...
    /**
     * Отображение имён функций для нужд сериализации в tmpl.
     */
...
export interface IExport extends TemplateFunction {
    ...
    /**
     * Коллекция шаблонных функций (inline, content, root).
     * Присутствует только в шаблонах tmpl для нужд сериализации.
     */
