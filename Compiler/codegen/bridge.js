define('Compiler/codegen/bridge', [
   ...
   function initWorkspaceWML(templateNames) {
      ...
      processingToFunction.inlineTemplateFunctions = [];
      processingToFunction.contentOptionStringBodies = { };
   ...
   function initWorkspaceTMPL(templateNames) {
      ...
      processingToFunction.inlineTemplateFunctions = null;
      processingToFunction.contentOptionStringBodies = null;
