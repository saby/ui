...
*/
define('Compiler/_expressions/third-party/parser', function () {
   /**
    */
   ...
   var beforejs = (function () {
      var o = function (k, v, o, l) {
         ...
         $V0 = [
            5, 9, 63, 64, 75, 76, 78, 79, 80, 88, 92, 96, 97, 98, 110, 115, 116,
         ...
         $Vt = [
            2, 9, 13, 24, 30, 34, 47, 48, 49, 50, 54, 55, 56, 57, 63, 64, 67,
            68, 69, 75, 76, 88, 90, 92, 93, 125
         ],
         $Vu = [
            2, 9, 13, 24, 30, 34, 47, 48, 49, 50, 54, 55, 56, 57, 63, 64, 93,
            125
         ],
         $Vv = [
            2, 9, 13, 24, 30, 34, 47, 48, 49, 50, 54, 55, 56, 57, 63, 64, 67,
            68, 69, 75, 76, 88, 90, 92
         ],
         $Vw = [2, 147],
         $Vx = [
            2, 9, 13, 24, 30, 34, 47, 48, 49, 50, 54, 55, 56, 57, 63, 64, 67,
         ...
         $VD = [
            2, 9, 13, 24, 25, 30, 34, 47, 48, 49, 50, 54, 55, 56, 57, 63, 64,
            67, 68, 69, 75, 76, 88, 89, 90, 92, 93, 111, 125
         ],
         $VE = [1, 123],
         $VF = [1, 128],
         $VG = [1, 138],
         ...
         $VO = [
            2, 9, 13, 24, 30, 34, 47, 48, 49, 50, 54, 55, 56, 57, 63, 64, 67,
            68, 69, 75, 76, 88, 90, 92, 93
         ],
         $VP = [2, 206],
         $VQ = [
            13, 24, 30, 34, 47, 48, 49, 50, 54, 55, 56, 57, 63, 64, 67, 68, 69,
            75, 76, 88, 90, 92
         ],
         $VR = [1, 184],
         $VS = [2, 158],
         ...
         $VV = [13, 89, 93],
         $VW = [
            2, 9, 13, 24, 25, 30, 47, 48, 49, 50, 54, 55, 56, 57, 63, 64, 67,
            68, 69, 75, 76, 88, 89, 90, 92, 93, 111, 125
         ],
         $VX = [1, 190],
         $VY = [
            2, 9, 13, 24, 25, 30, 34, 47, 48, 49, 50, 63, 64, 67, 68, 69, 75,
            76, 88, 89, 90, 92, 93, 111, 125
         ],
         $VZ = [1, 195],
         $V_ = [1, 196],
         $V$ = [1, 197],
         ...
         $V61 = [
            2, 9, 13, 24, 25, 30, 34, 47, 48, 49, 50, 54, 55, 56, 57, 63, 64,
            67, 68, 69, 75, 76, 89, 93, 111, 125
         ],
         $V71 = [1, 213],
         $V81 = [
            13, 63, 64, 75, 76, 78, 79, 80, 88, 89, 92, 96, 97, 98, 110, 115,
         ...
         $Vd1 = [1, 229],
         $Ve1 = [
            24, 30, 34, 47, 48, 49, 50, 54, 55, 56, 57, 63, 64, 67, 68, 69, 75,
            76, 88, 90, 92
         ],
         $Vf1 = [2, 27],
         $Vg1 = [2, 26];
      var parser = {
         ...
         table: [
            ...
            o(
               [
                  2, 9, 13, 24, 30, 34, 47, 48, 49, 50, 54, 55, 56, 57, 63, 64,
                  67, 68, 69, 125
               ],
               [2, 106]
            ),
            ...
            o(
               [
                  13, 24, 30, 34, 47, 48, 49, 50, 54, 55, 56, 57, 63, 64, 67,
                  68, 69, 75, 76
               ],
               $Vz,
               {
            ...
            o(
               [
                  2, 9, 13, 25, 34, 47, 48, 49, 50, 54, 55, 56, 57, 63, 64, 67,
                  68, 69, 75, 76, 88, 89, 90, 92, 93, 111, 125
               ],
               [2, 20],
               { 24: [1, 188], 30: [1, 189] }
            ...
            o(
               [
                  2, 9, 13, 24, 25, 30, 34, 54, 55, 56, 57, 63, 64, 67, 68, 69,
                  75, 76, 88, 89, 90, 92, 93, 111, 125
               ],
               [2, 53],
               {
            ...
            o(
               [
                  2, 9, 13, 24, 25, 30, 34, 47, 48, 49, 50, 54, 55, 56, 57, 67,
                  68, 69, 75, 76, 88, 89, 90, 92, 93, 111, 125
               ],
               [2, 86],
               { 63: [1, 199], 64: [1, 200] }
            ...
            o(
               [
                  2, 9, 13, 24, 25, 30, 34, 47, 48, 49, 50, 54, 55, 56, 57, 63,
                  64, 67, 68, 69, 88, 89, 90, 92, 93, 111, 125
               ],
               [2, 107],
               { 75: [1, 204], 76: [1, 205] }
            ),
            ...
            o(
               [
                  2, 9, 13, 24, 25, 30, 34, 47, 48, 49, 50, 54, 55, 56, 57, 63,
                  64, 67, 68, 69, 75, 76, 89, 92, 93, 111
               ],
               $VS,
               {
                  124: 119,
            ...
            o(
               [
                  2, 9, 24, 25, 30, 34, 47, 48, 49, 50, 54, 55, 56, 57, 63, 64,
                  67, 68, 69, 75, 76, 88, 89, 90, 92, 93, 111, 125
               ],
               [2, 213],
               { 13: $Vd1 }
