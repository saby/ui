import createJSDocProcessor from 'Compiler/_compiler/i18n/JSDoc';
...
describe('Compiler/_compiler/i18n/JSDoc', () => {
    ...
    describe('Types with definition', () => {
        it('Translatable object property in array', () => {
            const description = JS_DOC_PROCESSOR.getComponentDescription('UIModule/Component');
            assert.isTrue(
                description.isPropertyTranslatable('translatableArrayOption/translatableOption')
            );
        });
        it('Not translatable object property in array', () => {
            const description = JS_DOC_PROCESSOR.getComponentDescription('UIModule/Component');
            assert.isFalse(
                description.isPropertyTranslatable('translatableArrayOption/notTranslatableOption')
            );
        });
        it('Translatable object property', () => {
            const description = JS_DOC_PROCESSOR.getComponentDescription('UIModule/Component');
            assert.isTrue(
                description.isPropertyTranslatable('specialObjectOption/translatableProperty')
            );
        });
        it('Not translatable object property', () => {
            const description = JS_DOC_PROCESSOR.getComponentDescription('UIModule/Component');
            assert.isFalse(
                description.isPropertyTranslatable('specialObjectOption/notTranslatableProperty')
            );
        });
    });
});
