import { TreeBuilder } from 'Compiler/_compiler/html/TreeBuilder';
import { MarkupVisitor } from 'Compiler/_compiler/html/MarkupVisitor';
import createErrorHandler from '../NullLogger';
import { createSource } from 'Compiler/_compiler/html/Source';
import getTagDescription from 'Compiler/_compiler/html/Tags';
...
describe('Compiler/_compiler/html/TreeBuilder', () => {
    it('Tag', () => {
