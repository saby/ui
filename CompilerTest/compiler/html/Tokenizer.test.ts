import { createSource as creteSourceObj } from 'Compiler/_compiler/html/Source';
import createErrorHandler from '../NullLogger';
import { Tokenizer } from 'Compiler/_compiler/html/Tokenizer';
import { ContentModel } from 'Compiler/_compiler/html/ContentModel';
...
describe('Compiler/_compiler/html/Tokenizer', () => {
    describe('Data content model', () => {
        ...
        it('Instruction, xml=false', () => {
            const reader = createSource('<?xml version="1.0" encoding="utf-8"?>');
            stack = [
                {
                    type: 'EOF',
                },
