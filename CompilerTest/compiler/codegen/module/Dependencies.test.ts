import { createDependenciesController } from 'Compiler/_compiler/codegen/module/Dependencies';
import { assert } from 'chai';

describe('Compiler/_compiler/codegen/module/Dependencies', () => {
    ...
    it('Should return all dependencies', () => {
        ...
        const [refs, names] = controller.getDependencies();
        assert.deepEqual(refs, ['firstRef', 'thirdRef', 'secondRef', 'fourthRef']);
