...
describe('Compiler/_compiler/irCodegen/Generator', () => {
    ...
    describe('check code generation for data types', () => {
        ...
        it('should generate boolean with literal in expression 2', () => {
            const html = toComponentWithOption(`
                <ws:Boolean>{{ "invalid" }}</ws:Boolean>
            `);
        ...
        it('should generate number with literal in expression 2', () => {
            const html = toComponentWithOption(`
                <ws:Number>{{ "invalid" }}</ws:Number>
            `);
    ...
    describe('check code generation for components', () => {
        ...
        it('should generate content option with expressions', () => {
            const html = toComponent(
                'value="{{ value }}"',
