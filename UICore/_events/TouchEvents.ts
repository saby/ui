...
export default class TouchEventsReact {
    ...
    private addCaptureProcessingHandler(eventName: string, method: Function): void {
        if (this._rootDOMNode) {
            const handler = function (this: TouchEventsReact, _e: Event): void {
    ...
    private addHandler(eventName: string, handler: EventListener): void {
        const elementToSubscribe = (
            this.dontUseParentOnRoot ? this._rootDOMNode : this._rootDOMNode.parentNode
        ) as HTMLElement & {
            [subFlag: string]: boolean;
        };
        ...
        if (handlerInfo === null) {
            ...
            const bindedHandler = function (this: TouchEventsReact, _e: Event): void {
    ...
    private getHandlerInfo(eventName: string): IHandlerInfo | null {
        const handlers = this.capturedEventHandlers;
        if (handlers[eventName]) {
