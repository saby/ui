...
export type TScrollOnBodyContext = React.Context<IScrollOnBodyContextValue | undefined>;

/**
 * Контекст передает значение isScrollOnBody - индикатор включения/выключения скролла на body для мобильных устройств
 */
const ScrollOnBodyContext: TScrollOnBodyContext = React.createContext<
    IScrollOnBodyContextValue | undefined
>(undefined);
