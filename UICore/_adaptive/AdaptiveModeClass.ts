...
class Size {
    ...
    constructor(props: { value: number | undefined; valueMayBeIncorrect: boolean }) {
...
class Orientation {
    private readonly _isVertical: boolean | undefined;
...
export class AdaptiveModeClass implements AdaptiveModeType {
    ...
    constructor(params: IAspects) {
        ...
        this.window = {
            ...
            screenWidth: new Size({ value: params.screenWidth, valueMayBeIncorrect }),
            screenHeight: new Size({ value: params.screenHeight, valueMayBeIncorrect }),
        };
    ...
    _cloneIfNeed(aspects: IAspects): AdaptiveModeClass {
        ...
        const newAspects: IAspects = {
            ...
            screenWidth: aspects.screenWidth ?? this._aspects.screenWidth,
            screenHeight: aspects.screenHeight ?? this._aspects.screenHeight,
        ...
        if (
            ...
            oldAspects.screenWidth !== newAspects.screenWidth ||
            oldAspects.screenHeight !== newAspects.screenHeight ||
    ...
    toJSON(): ISerialized {
        ...
        return {
            ...
            // @ts-ignore Сериализатору на самом деле всё равно, строка или число.
            id: 'am_' + newCount,
            state: {
