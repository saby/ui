...
export type TAdaptiveModeContext = React.Context<IAdaptiveModeContextValue | undefined>;
 ...
 */
const AdaptiveModeContext: TAdaptiveModeContext = React.createContext<
    IAdaptiveModeContextValue | undefined
>(undefined);
