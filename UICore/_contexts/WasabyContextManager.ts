...
export function WasabyContextManager(
    ...
    const context = getWasabyContext();
    const { Provider } = context;
    let wasabyContext;
    let readOnly: IWasabyContextValue['readOnly'];
    let theme: IWasabyContextValue['theme'];
    let _physicParent: IWasabyContextValue['_physicParent'];
    let _logicParent: IWasabyContextValue['_logicParent'];
    let _parentKey: IWasabyContextValue['_parentKey'];
    let pageData: IWasabyContextValue['pageData'];
    let Router: IWasabyContextValue['Router'];
    let isAdaptive: IWasabyContextValue['isAdaptive'];
    let isScrollOnBody: IWasabyContextValue['isScrollOnBody'];
    let bubblingEvents: IWasabyContextValue['bubblingEvents'];
    let workByKeyboard: IWasabyContextValue['workByKeyboard'];
    try {
        wasabyContext = useContext(context);
        readOnly = props.readOnly ?? wasabyContext.readOnly;
        theme = props.theme ?? wasabyContext.theme;
        ...
        bubblingEvents = props.bubblingEvents ?? wasabyContext.bubblingEvents;
        ...
        Logger.error(message, props, error as Error);
        throw error;
    }
