...
function useActivityChangedCallback(
    callbackFromProps: TFocusChangedCallback | undefined,
    callbackFromContext: TFocusChangedCallback | undefined
): TFocusChangedCallback | undefined {
    const onActivityChanged = useMemo<TFocusChangedCallback | undefined>(() => {
...
function useFocusRef(
    focusRef: TFocusRef | undefined,
    refFromContext: TFocusRef | undefined
): TFocusRef | undefined {
    const joinedFocusRef = useMemo<TFocusRef | undefined>(() => {
    ...
    const focusContextValueBelow = useFocusContextValueBelow(
        () => {
            return new FocusContextValue({
                ...
                focusParentRef: props.focusParentRef ?? focusContextProps.focusParentRef,
                ref,
            });
        },
        [
            ...
            props.focusParentRef ?? focusContextProps.focusParentRef,
