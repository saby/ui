...
interface IReactFieldOwner {
    [REACT_FIBER_FIELD]?: unknown;
}

export function isReactElement(component: unknown): component is ReactElement {
    return (
        !!component && (component as IReactFieldOwner)[REACT_FIBER_FIELD] === SYMBOL_REACT_ELEMENT
    );
}

function isReactMemo(component: unknown): component is MemoExoticComponent<ComponentType> {
    return !!component && (component as IReactFieldOwner)[REACT_FIBER_FIELD] === SYMBOL_REACT_MEMO;
}
...
export function isForwardRef(component: unknown): component is ForwardRefExoticComponent<unknown> {
    ...
    return (
        realComponent &&
        (realComponent as IReactFieldOwner)[REACT_FIBER_FIELD] === SYMBOL_REACT_FORWARD_REF
    );
}
...
export function isContextConsumer(component: unknown): component is Consumer<unknown> {
    ...
    return (
        realComponent &&
        (realComponent as IReactFieldOwner)[REACT_FIBER_FIELD] === SYMBOL_REACT_CONTEXT_CONSUMER
    );
}
...
export function isContextProvider(component: unknown): component is Provider<unknown> {
    ...
    return (
        realComponent &&
        (realComponent as IReactFieldOwner)[REACT_FIBER_FIELD] === SYMBOL_REACT_CONTEXT_PROVIDER
    );
}
