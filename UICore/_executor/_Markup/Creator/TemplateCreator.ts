...
function getChangedOptionsPrivate(
    _prevProps: ITempleWrapperProps,
    _nextProps: ITempleWrapperProps
) {
...
function getChangedAttributesPrivate(
    _prevProps: ITempleWrapperProps,
    _nextProps: ITempleWrapperProps
) {
    ...
    return getChangedOptions(newAttrs, oldAttrs, undefined, undefined, false, false, true);
}

function getChangedInternalPrivate(
    _prevProps: ITempleWrapperProps,
    _nextProps: ITempleWrapperProps
) {
    ...
    return getChangedInternals(newInternal, oldInternal, oldInternalVersions, false, false, true);
}
 ...
 * @param context
 * @param config
 * @returns {React.ReactElement} Реакт обертка над шаблонной функцией
 */
