...
import type { Attr, IControlConfig } from 'UICommon/Executor';
import type { Control } from 'UICore/Base';
import type { TTemplateEventObject } from 'UICore/Events';
import { isValidChildren, TInternalProps } from 'UICore/Executor';
 ...
 * @example
 * Если для васаби контрола надо передать какие-то кастомные события, их следует передавать в качестве пропов с именем в формате on*
 * <pre>
 ...
 *         }, []);
 *         return <div>
 *              <WasabyControl onMyEvent={myHandler} />
 *         </div>;
 *    }
 * </pre>
 */
export function useElement<R = JSX.Element>(
    ...
    let refForContainer: React.Ref<any> | undefined;
    ...
    const templateConfig: IControlConfig = {
        depsLocal: {},
