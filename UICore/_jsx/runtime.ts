...
generateCreateElement(jsx_runtime, 'jsxs');
    ...
    function replaced(
        ...
        if (isWasabyControl || isWmlTemplate) {
            ...
            if (originName === 'createElement') {
                ...
                delete props.key;
                // В синтаксисе createElement children может передаваться аргументами после props.
                props.children = props.children || rest;
