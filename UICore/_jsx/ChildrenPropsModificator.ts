...
type TChildrenTypeModificator<
    P = any,
    T extends string | JSXElementConstructor<P> = string | JSXElementConstructor<P>,
> = (children: ReactElement<P, T>, nextProps: any, forwardRef: ForwardedRef<unknown>) => P;
...
class ChildrenPropsModificator {
    ...
    protected chooseRightAction(children: ReactElement): TChildrenTypeModificator | undefined {
