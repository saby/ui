...
export default class ShouldComponentUpdateDecorator {
    ...
    addReason(reasonGettersMap: IReasonGetters): ShouldComponentUpdateDecorator {
    ...
    exec(): IShouldComponentUpdateResult {
        ...
        const hasChangesInternalOptions = this._reasonGettersMap.hasChangesInternalOptions();
