...
export class WasabyHooksQueue {
    ...
    private insertBefore(queueElement: IQueueElement, refQueueElement: IQueueElement): void {
        if (!this.tail) {
    ...
    private createQueueElement(data: TFunction, owner: TControl): IQueueElement {
        return {
            next: undefined,
            prev: undefined,
            data,
