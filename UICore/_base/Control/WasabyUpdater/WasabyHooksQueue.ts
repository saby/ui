 ...
 */
import { TAnyControl } from '../../interfaces';
...
export class WasabyHooksQueue {
    private hookPlacement: Map<TAnyControl, IQueueElement> = new Map();
     ...
     */
    enqueue(owner: TAnyControl, hook: TFunction): void {
        ...
        let parent: TAnyControl = owner.props._physicParent;
        while (parent) {
     ...
     */
    dequeue(owner: TAnyControl): void {
    ...
    private insertBefore(
        ...
        refQueueElement: IQueueElement | undefined
    ): void {
        if (!this.tail) {
    ...
    private createQueueElement(data: TFunction, owner: TAnyControl): IQueueElement {
        return {
            next: undefined,
            prev: undefined,
            data,
