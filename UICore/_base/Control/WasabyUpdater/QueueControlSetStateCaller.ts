...
export default class QueueControlSetStateCaller {
    ...
    private plannedUpdates: Map<Control<unknown, unknown>, IControlUpdateInfo> = new Map();
    ...
    enqueue(instance: Control<unknown, unknown>, order: number, setStateHandler: TFunction): void {
