...
export default class WasabyUpdater {
    ...
    planUpdate(instance: Control<unknown, unknown>, updateHandler: TFunction): void {
    ...
    registerErrorControl(instance: Control<unknown, unknown>): void {
    ...
    private getDepth(sourceInst: Control<TWasabyOverReactProps, unknown>): number {
        let depth: number = 0;
