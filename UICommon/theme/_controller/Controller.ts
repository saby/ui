...
/**
 * Имя темы. Используется, если в getVariables передан ровно один аргумент.
 * Планиурется отказ от этой системы в пользу новой.
 * @deprecated
 */
...
export class Controller {
    ...
    getVariables(
        ...
        /** Имя темы или файла может прилететь вот таким 'default\\" onload=\\"console.log(\'XSS\')\\"' */
        const theme = escapeHtml(sitetype);
    ...
    async getActiveTheme(
        _sitetype?: TSiteType | TThemeName,
