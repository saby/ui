...
import { Head as HeadAPI, IPageTagAttrs, IPageTagId } from 'Application/Page';
...
export default class Link extends Base implements ICssEntity {
    ...
    constructor(
        ...
        if (element) {
            ...
            this.themeType = this.themeType || element.getAttribute(ELEMENT_ATTR.THEME_TYPE);
        }
    }
    ...
    mountElement(): Promise<void> {
        return new Promise((resolve, reject) => {
            ...
            const timeout = setTimeout(onerror, TIMEOUT);
