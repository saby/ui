...
/**
 * СРекурсивно проходит по всему дереву зависимостей и создает объект со списком всех зависимостей заданных модулей
 * { js: {}, css: {}, ..., wml: {} }
 * @param allDeps
 * @param curNodeDeps
 * @param modDeps
...
function mergePacks(
    result: IDepPackages,
    addedPackages: Partial<IDepPackages>
): void {
