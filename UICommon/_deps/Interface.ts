...
export interface IModuleDependenciesRaw<TLinks = number[]> {
    nodes: Record<string, { path: string; amd?: boolean }>;
    links: Record<string, TLinks>;
    nodesList?: string[];
}

export interface IModulesDeps<TLinks = string[]> extends IModuleDependenciesRaw<TLinks> {
