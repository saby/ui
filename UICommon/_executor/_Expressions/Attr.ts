...
export function processMergeAttributes(
    ...
    addAttribute(ownAttributes, 'class', mergeAttr(parentAttributes, ownAttributes, 'class'));
    addAttribute(ownAttributes, 'style', mergeAttr(parentAttributes, ownAttributes, 'style', ';'));
