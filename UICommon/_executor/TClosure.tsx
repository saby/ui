...
const iterators = [
    {
        ...
        iterator: function recordsetIterator(recordset: IRecordSet, callback: TIteratorCallback): void {
    ...
    },
    {
        ...
        iterator: function objectIterator(object: Record<string, unknown>, callback: TIteratorCallback): void {
