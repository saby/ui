 ...
 * @private
 */
function isHexOrRGBColor(strValue: string | boolean | undefined): boolean {
...
export default forwardRef(function BackgroundViewer(
    ...
    const [isLightScheme, opacityValue] = useMemo(() => {
        ...
        let baseColor: string | undefined = color;
        ...
        if (baseColor && (isGradientColor || isHexOrRGBColor(baseColor))) {
            const _isLightScheme = isLight(
                isGradientColor ? dominantColor : baseColor,
                undefined,
                undefined,
    ...
    let backgroundStyles: CSSProperties | undefined = useMemo((): CSSProperties => {
        ...
        image,
        props.style,
        shouldNotAddBackgroundStyle,
        props.useChildrenContainer,
    ]);
    ...
    if (props.useChildrenContainer && isReactElement(props.children)) {
        ...
        if (backgroundStyles && !backgroundStylesClassName) {
            newChildrenProps.style = backgroundStyles;
        }
        if (backgroundStylesClassName) {
            newChildrenProps.className =
                newChildrenProps.className + ' ' + backgroundStylesClassName;
        }
    ...
    const backgroundLayer =
        !props.noBackground88221033455786 && !!backgroundStyles ? (
