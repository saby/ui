...
export default class State extends TagMarkup implements IMetaStateInternal {
    constructor(
        ...
        private _nextStateId: string | undefined = void 0,
        private _prevStateId: string | undefined = void 0
    ) {
    ...
    getNextStateId(): string | undefined {
    ...
    getPrevStateId(): string | undefined {
