...
import { getResourceUrl, escapeHtml } from 'UI/Utils';
...
const HTML_VOID_ELEMENTS: Record<string, boolean> = {
    area: true,
    base: true,
    br: true,
    col: true,
...
function __getResourceUrl(url: string, config: ITagMarkupConfig | undefined): string {
