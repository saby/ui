...
import { getConfig, LogLevel } from 'Application/Env';
 ...
 */
function getNumericLogLevel(logLevel?: IHeadOptions['logLevel']): LogLevel {
    if (logLevel === 'warning') {
    ...
    // logLevel === 'info' или по умолчанию
