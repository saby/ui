...
describe('Определение типа компонента', () => {
    ...
    it('Вставка Context Provider в wasaby', () => {
        // region Setup
        act(() => {
            creator(WasabyRoot, { contextProvider: true }, container);
        });
        tick(0);
        // endregion
    ...
    it('Вставка Context Consumer в wasaby', () => {
        // region Setup
        act(() => {
            creator(WasabyRoot, { contextConsumer: true }, container);
        });
        tick(0);
        // endregion
