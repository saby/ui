import { TemplateWrapperClass } from 'UICore/_executor/_Markup/Creator/TemplateCreator';

function areEqualTemplateWrapperProps(prevProps, nextProps): boolean {
    const templateWrapperClass = new TemplateWrapperClass(prevProps);
    return !templateWrapperClass.shouldComponentUpdate(nextProps);
}
