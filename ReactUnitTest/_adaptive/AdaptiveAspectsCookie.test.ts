...
describe('adaptiveAspects cookie', () => {
    ...
    test('valid', () => {
        ...
        // todo здесь в snap везде isTouch = true потому что в определялке EnvTouch/_EnvTouch/Touch.js
        // видит window.TouchEvent, значит считает что есть тач. Это в jsdom просто поддержка такая.
