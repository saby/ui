...
function sortedAddControlNode(
    controlNodes: IControlNode[],
    newControlNode: IControlNode
): void {
...
export function prepareControlNodes(
    node: TControlNode,
    control: Control<unknown, unknown>
): void {
    ...
    if (control._container !== container) {
        ...
        if (control._container) {
            ...
            const dataComponent =
                control._container.getAttribute('data-component');
            if (dataComponent) {
