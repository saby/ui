    ...
    implements IWasabyControl
{
     ...
     * @private
     */
    controlNodesAfterUnmount: IControlNode[]; // todo нужно только в Notify
    ...
    _forceUpdate(changedFieldName: string = '_forceUpdate()'): void {
        this.logic._forceUpdate(changedFieldName);
    }
...
function checkApiRedefined<TOptions, TState>(
    ...
    const redefinedApi = checkReactApiRedefined<TOptions, TState>(control);
