...
import type { TControlOptionsExtended, TInternalsCollection, TVersionsCollection } from 'UICommon/Vdom';
import {
...
`
    ...
    protected _beforeFirstRender(options: TOptions): void {
        ...
        this._optionsVersions = collectObjectVersions(options as unknown as TControlOptionsExtended);
        this._internalOptionsVersions = collectInternalsVersions(options._$internal as unknown as TInternalsCollection);
