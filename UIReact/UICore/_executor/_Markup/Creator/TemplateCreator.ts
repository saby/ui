 ...
 * @returns
 */
const TemplateWrapperVar: TTemplateWrapper = function TemplateWrapper(props): TemplateResult {
    const physicParent = props._$stateToCompareProps.physicParent;
    const logicParent = props._$stateToCompareProps.logicParent;
    const template = props._$stateToCompareProps.template;
    const resolvedScope = props._$stateToCompareProps.resolvedScope;
    ...
    useUpdateMaps(props);
    const generatorConfig = props.generatorConfig;
    ...
    resolvedScope.ref = props.forwardedRef || resolvedScope.ref;
    resolvedScope._$templateKeyPostfix = props._$stateToCompareProps._$templateKeyPostfix;
 ...
 */
export function areEqualTemplateWrapperProps(_prevReactProps, _nextProps): boolean {
