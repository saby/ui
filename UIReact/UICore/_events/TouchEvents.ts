...
const SPECIAL_EVENT = ['swipe', 'longtap'];
...
export default class TouchEventsReact {
    ...
    protected initHandlers(): void {
        this.addCaptureProcessingHandler(
            'click',
            this._touchHandlers.handlerClick
        );
        this.addCaptureProcessingHandler(
            'touchstart',
            this._touchHandlers.handlerTouchstart
        );
        this.addCaptureProcessingHandler(
            'touchmove',
            this._touchHandlers.handlerTouchmove
        );
        this.addCaptureProcessingHandler(
            'touchend',
            this._touchHandlers.handlerTouchend
        );
    }

    private addCaptureProcessingHandler(
        eventName: string,
        method: Function
    ): void {
