...
export class AdaptiveModeClass implements AdaptiveModeType {
    ...
    constructor(params: IAspects) {
        ...
        this.container = {
            ...
            scrollWidth: new Size({ value: params.containerScrollWidth, valueMayBeIncorrect }),
            scrollHeight: new Size({ value: params.containerScrollHeight, valueMayBeIncorrect }),
        };
        this.window = {
