...
export function useElement<R = JSX.Element>(
    ...
    if (!props.adaptiveMode) {
        ...
        // Если не было props.adaptiveMode, то в props буджет isAdaptive=false, т.к. это его значение по умолчанию.
        // Поэтому при выставлении adaptiveMode из контекста так же выставляем isAdaptive из контекста.
