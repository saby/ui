...
function isAsyncContainer(
    C: unknown,
    name: string
): C is Control<IAsyncProps, unknown> {
...
export let logExecutionTimeEnd = (
...
if (typeof window === 'undefined') {
    ...
    logExecutionTimeBegin =
        function logExecutionTimeBegin(): LogTimepestampStart {
            if (
