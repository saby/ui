...
define([
   ...
   'ReactUnitTest/Focus'
], function (Focus, Base, Env, ElementFinder, _ResetScrolling, FocusTestControls) {
   'use strict';
   ...
   describe('Focus', function () {
      ...
      function createTests(testCases) {
         ...
         for (var i = 0; i < testCases.length; ++i) {
            it(testCases[i].name || `test localCases[${i}]`, getCaseFunction(testCases[i]));
         }
      }
         ...
         var localCases = [
            ...
            },
            {
               ...
               checkFn: function () {
                  ...
                  expect(div).toMatchSnapshot('Нет бесполезных ws-autofocus в вёрстке');
               }
            },
            {
