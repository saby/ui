...
describe('дочерние контролы', () => {
    ...
    it('наличие дочернего DOM элемента', () => {
        ...
        expect(instance._children.rootElement instanceof HTMLDivElement).toBe(
            true
        );
    });
                ...
                ControlWithChildren,
                {
                    check: (childName) => {
                        expect(childName).toBe(
                            'ReactUnitTest/_base/resources/ChildrenTest/Child'
                        );
                    },
                },
                container
    ...
    test('устанавливается правильный ребенок', () => {
        ...
        expect(instance.getChild()._children.MyControl).toBeInstanceOf(
            Child2Control
        );
    });
    ...
    it('react component с заданным в wml name попадает в _children', () => {
        ...
        expect(instance.getChildReactComponent()).toBeInstanceOf(
            ChildReactComponent
        );
    });
    ...
    it('функциональный контрол попадает в children как специальный класс с _container', () => {
        ...
        act(() => {
            render(<Wasaby1 ref={(v)=>{instance = v;}}/>, container);
        });
