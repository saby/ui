   ...
   let tests = {
      'Test class stored through inline template': {
         ...
         checkers: [
            checkStr(
               '' +
                  '<div tabindex="0" class="iAmDiv iAmClass">Hi</div>' +
                  '<div tabindex="0" class="iAmDiv iAmClassToo">Hi</div>'
            )
         ]
      },
      'Test merge classes': {
         ...
         checkers: [
            checkStr(
               '<div tabindex="0" class="innerClass outerClass">Text</div>'
            )
         ]
      },
      'Test merge styles': {
         ...
         checkers: [
            checkStr(
               '<div tabindex="0" style="color:red;font-size:13px">Text</div>'
            )
         ]
      },
      'Test merge styles 2': {
