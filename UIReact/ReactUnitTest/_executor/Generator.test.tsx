...
describe('Генератор', () => {
    ...
    it('Отсутствие корневого элемента шаблона контрола приводит к ошибке', () => {
        ...
        expect(consoleMock.mock.calls[1][1]).toContain('Контрол не был смонтирован в DOM-дерево.');
    });
    ...
    it('Отсутствие контентной опции шаблона приводит к ошибке', () => {
        ...
        expect(consoleMock.mock.calls[2][1]).toContain('Контрол не был смонтирован в DOM-дерево.');
    });
});
