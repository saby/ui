...
import WithForwardRefParent from './resources/ReactComponent/WithForwardRefParent';
...
describe('Определение типа компонента', () => {
    ...
    it('Functional Component', async () => {
        ...
        let instance;
        act(() => {
            instance = creator(WasabyRoot, { reactFunction: true }, container);
        });
        tick(0);
        // endregion
    ...
    it('Wasaby Controls', async () => {
        ...
        let instance;
        act(() => {
            instance = creator(WasabyRoot, { wasabyControl: true }, container);
        });
        tick(0);
        // endregion
    ...
    it('Вставка forwardRef в wasaby', async () => {
        ...
        let instance;
        act(() => {
            instance = creator(WithForwardRefParent, {}, container);
        });
        tick(0);
        // endregion
