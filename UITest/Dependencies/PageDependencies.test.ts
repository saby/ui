...
describe('UICommon/_deps/PageDependencies', () => {
    ...
    beforeAll(() => {
        ...
        pageDependencies = new PageDependencies(
            depsCollector,
            'UnitTestPageDependencies'
        );
    });
    ...
    describe('UICommon/Deps:addPageDeps', () => {
        it('add module', () => {
            ...
            expect(pageDependencies.pageDeps).toEqual(
                expect.arrayContaining([moduleName])
            );
        });
        ...
        it('add library', () => {
            ...
            pageDependencies.addPageDeps([moduleName]);
            expect(pageDependencies.pageDeps).toEqual(
                expect.arrayContaining([libName])
            );
        });
    });
