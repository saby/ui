/* global assert */
define([
   'Compiler/_expressions/Statement',
   'Compiler/_expressions/Bind',
   'Compiler/_expressions/Nodes',
   'Compiler/_expressions/Parser',
   'Compiler/_codegen/Expression'
], function (
   StatementLib,
   BindLib,
   ExpressionNodes,
   ...
   describe('Compiler/codegen/Expression', function () {
      describe('class ExpressionVisitor', function () {
         ...
         describe('Internal expressions', function () {
            it('Check function before apply it', function () {
               ...
               const standard =
                  'thelpers.callIFun(thelpers.getter(data, ["a","b","c"]), thelpers.getter(data, ["a","b"]), ["g"])&&thelpers.getter(data, ["a","b","d"])&&thelpers.getter(data, ["a","b","e","f"])';
               assert.strictEqual(actual, standard);
            });
            ...
            it('Check nested functions', function () {
               ...
               const actual = processExpression(html, '__dirtyCheckingVars_0');
               const standard =
                  'thelpers.callIFun(thelpers.getter(data, ["a"]), funcContext, [thelpers.getter(data, ["b"]),thelpers.callIFun(thelpers.getter(data, ["c"]), funcContext, [thelpers.getter(data, ["d"]),thelpers.callIFun(thelpers.getter(data, ["e"]), funcContext, [thelpers.getter(data, ["f"])]),thelpers.getter(data, ["g"])]),thelpers.getter(data, ["h"])])';
               assert.strictEqual(actual, standard);
            });
         });
      ...
      describe('class BindExpressionVisitor', function () {
         ...
         describe('Spec', function () {
            it('Bind on identifier', function () {
               ...
               assert.strictEqual(
                  functionString,
                  'thelpers.setter(data, ["identifier"], value)'
               );
            });
            it('Bind on context identifier', function () {
               ...
               assert.strictEqual(
                  functionString,
                  'thelpers.setter(data, ["data","property","identifier"], value)'
               );
            });
            ...
            it('Bind on computed context identifier 2', function () {
               ...
               assert.strictEqual(
                  functionString,
                  'thelpers.setter(data, ["data",thelpers.getter(data, ["property"]),"identifier"], value)'
               );
            });
            it('Bind on computed context identifier 3', function () {
               ...
               assert.strictEqual(
                  functionString,
                  'thelpers.setter(data, ["data",(thelpers.getter(data, ["condition"]) ? thelpers.getter(data, ["first"]) : thelpers.getter(data, ["second"])),"identifier"], value)'
               );
            });
            it('Bind on computed context identifier 4', function () {
               const functionString = processBindExpression(
                  'data[property.getName()].identifier'
               );
               assert.strictEqual(
                  functionString,
                  'thelpers.setter(data, ["data",thelpers.getter(data, ["property","getName"]).apply(thelpers.getter(data, ["property"]), []),"identifier"], value)'
               );
            });
            it('Bind on record on _options', function () {
               const functionString = processBindExpression(
                  '_options.record.field'
               );
               assert.strictEqual(
                  functionString,
                  'thelpers.setter(data, ["_options","record","field"], value)'
               );
            });
         });
      ...
      describe('class EventExpressionVisitor', function () {
         describe('Spec', function () {
            ...
            it('Simple handler with identifier as argument', function () {
               ...
               assert.strictEqual(
                  result.args[0],
                  'thelpers.getter(data, ["identifier"])'
               );
               assert.strictEqual(
                  result.fn,
                  'thelpers.getter(this, ["_handler"])'
            ...
            it('Context handler', function () {
               const result = processEventExpression(
                  'data.property._handler()'
               );
               assert.strictEqual(result.handlerName, '_handler');
               assert.strictEqual(result.args.length, 0);
               assert.strictEqual(
                  result.fn,
                  'thelpers.getter(this, ["data","property","_handler"])'
               );
               assert.strictEqual(
                  result.context,
                  'thelpers.getter(this, ["data","property"])'
               );
            });
            it('Context handler with identifier as argument', function () {
               const result = processEventExpression(
                  'data.property._handler(identifier)'
               );
               assert.strictEqual(result.handlerName, '_handler');
               assert.strictEqual(result.args.length, 1);
               assert.strictEqual(
            ...
            it('Handler with the same name as parent', function () {
               ...
               assert.strictEqual(
                  result.fn,
                  'thelpers.getter(this, ["process"])'
               );
               assert.strictEqual(result.context, 'this');
            });
            it('Context handler with parent', function () {
               const result = processEventExpression('parent.handler()', [
                  'parent'
               ]);
               ...
               assert.strictEqual(
                  result.fn,
                  'thelpers.getter(this._children, ["parent","handler"])'
               );
               assert.strictEqual(
                  result.context,
                  'thelpers.getter(this._children, ["parent"])'
               );
            });
            ...
            it('Long context handler with parent', function () {
               ...
               assert.strictEqual(
                  result.fn,
                  'thelpers.getter(this._children, ["a","b","c","d","e","f","g"])'
               );
               assert.strictEqual(
                  result.context,
                  'thelpers.getter(this._children, ["a","b","c","d","e","f"])'
               );
            });
            it('Long context handler', function () {
               ...
               assert.strictEqual(
                  result.fn,
                  'thelpers.getter(this, ["a","b","c","d","e","f","g"])'
               );
               assert.strictEqual(
                  result.context,
                  'thelpers.getter(this, ["a","b","c","d","e","f"])'
               );
            });
            it('Handler arguments with parent', function () {
               const result = processEventExpression(
                  'parent.handler(a, parent.b)',
                  ['parent']
               );
               assert.strictEqual(result.handlerName, 'handler');
               ...
               assert.strictEqual(
                  result.args[0],
                  'thelpers.getter(data, ["a"])'
               );
               assert.strictEqual(
                  result.args[1],
                  'thelpers.getter(data, ["parent","b"])'
               );
               assert.strictEqual(
                  result.fn,
                  'thelpers.getter(this._children, ["parent","handler"])'
         ...
         describe('Stress', function () {
            ...
            it('Computed context handler', function () {
               try {
                  ...
                  assert.strictEqual(
                     error.message,
                     'Вычисляемые member-выражения запрещены'
                  );
                  return;
               }
               throw new Error('This test must be failed');
