...
define(['Compiler/_codegen/function'], function (functionModule) {
   describe('Generating debug names of functions', function () {
      ...
      describe('getFuncNameByFile', function () {
         ...
         it('tmpl!', function () {
            var funcName =
               functionModule.getFuncNameByFile('tmpl!A.B/_c-d/e:f');
            assert.isTrue(funcName === 'A_B__c_d_e_f');
         });
         it('*.tmpl', function () {
            var funcName =
               functionModule.getFuncNameByFile('A.B/_c-d/e:f.tmpl');
            assert.isTrue(funcName === 'A_B__c_d_e_f');
         });
      ...
      describe('getFuncName', function () {
         it('undefined to Unknown', function () {
            ...
            var funcName2 = functionModule.getFuncName(
               undefined,
               undefined,
               undefined
            );
            ...
            var funcName3 = functionModule.getFuncName(
               undefined,
               undefined,
               undefined
            );
      ...
      describe('setFunctionName', function () {
         ...
         it('names for not anonymous function', function () {
            ...
            assert.isTrue(
               funcName === 'testFunction' && func.name === 'testFunction'
            );
