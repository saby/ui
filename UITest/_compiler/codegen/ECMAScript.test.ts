import {
    ...
    ECMAScript2021,
    ECMAScript5
} from 'Compiler/_codegen/ECMAScript';

describe('Compiler/_codegen/ECMAScript', () => {
    ...
    describe('ES2021', () => {
        ...
        it('should generate valid object', () => {
            ...
            expect(generator.genObject(object)).toEqual('{ [prop]: 123, "property": property, /*#SUBSTITUTION#*/ "not-identifier": not-identifier, }');
        });
        ...
        it('should generate valid arrow function 2', () => {
            expect(generator.genArrowFunction('return a + b;', ['a', 'b'])).toEqual('(a,b) => { return a + b; }');
        });
        ...
        it('should generate nullish coalescing expression', () => {
            expect(generator.genNullishCoalescingOperator('value', 'true')).toEqual('(value) ?? (true)');
        });
        ...
        it('should generate dynamic object property accessor', () => {
            expect(generator.genDynamicObjectPropertyAccessor('object', 'property')).toEqual('object[propertyDynamic]');
        });
    });
    describe('ES5', () => {
        ...
        it('should generate valid object', () => {
            ...
            expect(generator.genObject(object)).toEqual('{ "property": property, /*#SUBSTITUTION#*/ "not-identifier": not-identifier, }');
        });
        ...
        it('should generate valid arrow expression 2', () => {
            expect(generator.genArrowExpression('a + b', ['a', 'b'])).toEqual('function(a,b){ return a + b; }');
        });
        it('should generate valid arrow function 1', () => {
            expect(generator.genArrowFunction('return 123;')).toEqual('function(){ return 123; }');
        });
        it('should generate valid arrow function 2', () => {
            expect(generator.genArrowFunction('return a + b;', ['a', 'b'])).toEqual('function(a,b){ return a + b; }');
        });
        it('should generate string interpolation', () => {
            expect(generator.genStringInterpolation('_${value}_')).toEqual('"_" + value + "_"');
        });
        it('should generate optional chaining', () => {
            expect(generator.genOptionalChaining('a.b?.c?.d.e')).toEqual('(a.b && a.b.c && a.b.c.d.e)');
        });
        it('should generate nullish coalescing expression', () => {
            expect(generator.genNullishCoalescingOperator('value', 'true')).toEqual('typeof (value) === "undefined" ? (true) : (value)');
        });
        it('should generate dynamic object property', () => {
            expect(generator.genDynamicObjectProperty('property')).toEqual('property');
        });
        it('should generate dynamic object property accessor', () => {
            expect(generator.genDynamicObjectPropertyAccessor('object', 'property')).toEqual('object.property');
        });
    });
});
