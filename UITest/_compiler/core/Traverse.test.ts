...
describe('Compiler/core/Traverse', () => {
    ...
    describe('ElementNode', () => {
        ...
        it('Attributes', () => {
            ...
            const elementNode = <Ast.ElementNode>tree[0];
            assert.strictEqual(
                Object.keys(elementNode.__$ws_attributes).length,
                2
            );
            assert.strictEqual(Object.keys(elementNode.__$ws_events).length, 1);

            assert.isTrue(
                elementNode.__$ws_attributes.hasOwnProperty('attr:class')
            );
            assert.isTrue(
                elementNode.__$ws_attributes.hasOwnProperty('attr:id')
            );
            assert.isTrue(elementNode.__$ws_events.hasOwnProperty('on:click'));

            assert.instanceOf(
                elementNode.__$ws_attributes['attr:class'],
                Ast.AttributeNode
            );
            assert.instanceOf(
                elementNode.__$ws_attributes['attr:id'],
                Ast.AttributeNode
            );
            assert.instanceOf(
                elementNode.__$ws_events['on:click'],
                Ast.EventNode
            );
        });
    ...
    describe('ComponentNode', () => {
        ...
        it('Component attributes and options', () => {
            ...
            assert.strictEqual(
                Object.keys(componentNode.__$ws_attributes).length,
                1
            );
            assert.strictEqual(
                Object.keys(componentNode.__$ws_options).length,
                1
            );
            assert.strictEqual(
                Object.keys(componentNode.__$ws_events).length,
                0
            );
            assert.strictEqual(
                Object.keys(componentNode.__$ws_contents).length,
                0
            );
            assert.isTrue(
                componentNode.__$ws_attributes.hasOwnProperty('attr:class')
            );
        ...
        it('Component event handlers', () => {
            ...
            assert.isTrue(
                componentNode.__$ws_events.hasOwnProperty('on:click')
            );
        });
        it('Component contents', () => {
         ...
         `;
            ...
            assert.isTrue(
                componentNode.__$ws_contents.hasOwnProperty('content')
            );
            assert.isTrue(
                componentNode.__$ws_contents.hasOwnProperty('contentOption')
            );
        });
    ...
    describe('Data types', () => {
        describe('Data type directive', () => {
            ...
            `;
                ...
                assert.isTrue(
                    functionNode.__$ws_options.hasOwnProperty('arg1')
                );
                assert.isTrue(
                    functionNode.__$ws_options.hasOwnProperty('arg2')
                );
            });
            it('Number', () => {
                const optionTemplate = `
            ...
            `;
                ...
                const properties = (<Ast.ObjectNode>option.__$ws_value)
                    .__$ws_properties;
