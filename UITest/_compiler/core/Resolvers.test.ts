import * as Resolvers from 'Compiler/_core/Resolvers';
...
describe('Compiler/core/Resolvers', () => {
    describe('parseComponentName() Simple', () => {
        ...
        it('getFullPath() with special UI module name', () => {
            const path = Resolvers.parseComponentName(
                'SBIS3.CONTROLS.Component'
            );
    ...
    describe('parseComponentName() Module', () => {
        ...
        it('getFullPath() with special UI module name', () => {
            const path = Resolvers.parseComponentName(
                'SBIS3.CONTROLS.Module:Component'
            );
            assert.strictEqual(
                path.getFullPath(),
                'SBIS3.CONTROLS/Module:Component'
    ...
    describe('parseFunctionPath()', () => {
        ...
        it('getFullPath() with special UI module name', () => {
            const path = Resolvers.parseTemplatePath(
                'SBIS3.CONTROLS/Module:object.handler'
            );
            assert.strictEqual(
                path.getFullPath(),
                'SBIS3.CONTROLS/Module:object.handler'
    ...
    describe('parseTemplatePath() Simple', () => {
        ...
        it('getFullPath() with special UI module name', () => {
            const path = Resolvers.parseComponentName(
                'SBIS3.CONTROLS/Module/Template'
            );
            assert.strictEqual(
                path.getFullPath(),
                'SBIS3.CONTROLS/Module/Template'
